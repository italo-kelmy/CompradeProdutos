...
public class Usuarios {
    ...
    @Pattern(regexp = "^\\d{2} \\d{4,5}-\\d{4}$", message = "Formato incorreto. Exemplo: XX XXXX-XXXX")
    private String telefone;
    @Pattern(regexp = "^\\d{5}-\\d{3}$", message = "Formato incorreto. Exemplo: XXXXX-XXX")
    private String cep;
    private String role;
    ...
    public Usuarios(Long id, String usuario, String senha, String email, String telefone, String cep, String role) {
        this.id = id;
